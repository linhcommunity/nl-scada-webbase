...
export const updateDevice = (siteId, deviceId, data) =>
  apiClient.put(`/sites/${siteId}/devices/${deviceId}`, data);
...
export const updateTag = (siteId, deviceId, tagId, data) =>
  apiClient.put(`/sites/${siteId}/devices/${deviceId}/tags/${tagId}`, data);
